...
public class RestaurantOrderServiceImpl implements RestaurantOrderService {
    ...
    private RestaurantOrderDto mapToDto(RestaurantOrder entity) {
        ...
        // ✅ FIX: LocalDateTime → String
        dto.setOrderDate(entity.getOrderDate() != null
                ? entity.getOrderDate().toString()
                : null);

        // ✅ FIX: BigDecimal → double
        dto.setTotalCost(entity.getTotalCost() != null
    ...
    private RestaurantOrder mapToEntity(RestaurantOrderDto dto) {
        ...
        // ✅ FIX: String → LocalDateTime
        if (dto.getOrderDate() != null) {
            entity.setOrderDate(
                    java.time.LocalDateTime.parse(dto.getOrderDate().substring(0, 19))
            );
        }

        // ✅ FIX: double → BigDecimal
        entity.setTotalCost(java.math.BigDecimal.valueOf(dto.getTotalCost()));
