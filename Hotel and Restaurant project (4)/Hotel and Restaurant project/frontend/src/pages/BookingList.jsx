...
const BookingList = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      // ✅ Filter only logged-in customer bookings
              ...
              {bookings.length > 0 ? (
                bookings.map((b) => (
                  ...
                  >
                    ...
                    <td style={{ padding: '1rem' }}>
                      <span
                        className="status-badge status-blue"
                        style={{ fontSize: '0.7rem' }}
                      >
                        {b.bookingType || 'Full Day'}
                      </span>
                    </td>

                    <td style={{ padding: '1rem' }}>
                      <span
                        className={`bg-secondary bg-opacity-20 text-secondary px-2 py-1 rounded text-xs text-transform-capitalize ${
                          b.status === 'canceled'
                        ...
                        {b.status !== 'canceled' &&
                         b.status !== 'checked-out' && (
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleCancel(b.reservationId, b)
                            }
