...
const ManageRooms = () => {
  ...
  const fetchRooms = async () => {
    try {
      const response = await axios.get(`${API}/rooms`, getHeaders());
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      alert(
        'This room cannot be deleted because it already has bookings, bills, or service requests.\n\nPlease change the room status to Maintenance instead.'
      );
    }
  };
